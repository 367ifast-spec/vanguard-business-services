...
export default async function ListingPage({
  ...
  const listing =
    await getMarketplaceListingBySlug(
      String(slug)
    );
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-3">
          ...
          <div>
            <div className="rounded-2xl bg-[#111827] p-8">
              ...
              <button
                type="button"
                className="mt-6 w-full rounded-xl bg-indigo-600 py-4 font-semibold"
              >
                Contact Seller
              </button>
              ...
              <button
                type="button"
                className="mt-4 w-full rounded-xl border border-white/20 py-4"
              >
                Add to Watchlist
              </button>
            </div>
