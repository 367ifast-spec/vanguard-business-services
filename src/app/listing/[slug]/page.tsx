        ...
        <div className="mt-10 grid gap-10 md:grid-cols-3">
          <div className="md:col-span-2">
            ...
            <p className="mt-6 text-gray-300">
              This premium digital asset is available
              for purchase through Vanguard Marketplace.
            </p>
          ...
          <div>
            <div className="rounded-2xl bg-[#111827] p-8">
              ...
              <Link
                ...
                className="mt-6 block w-full rounded-xl bg-indigo-600 py-4 text-center font-semibold transition hover:bg-indigo-700"
              >
                Contact Seller
              </Link>
